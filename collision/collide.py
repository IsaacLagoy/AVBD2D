...
def sat(pos_a, pos_b, irs_a, rs_b, norms_a, dots_a, verts_b):    
    ...
    norms_r_sinv = fltrd_norms @ irs_a @ rs_b
    ...
    r_sinv_dots = norms_r_sinv @ verts_b.T 
...
def collide(manifold) -> bool:
    ...
    data_a = sat(body_a.pos, body_b.pos, body_a.inv_rot_sca_mat, body_b.rot_sca_mat, body_a.mesh.normals, body_a.mesh.dots, body_b.vertices)
    data_b = sat(body_b.pos, body_a.pos, body_b.inv_rot_sca_mat, body_a.rot_sca_mat, body_b.mesh.normals, body_b.mesh.dots, body_a.vertices)
